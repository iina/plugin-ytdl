declare namespace YTDL {
    export type Protocol = "http" | "https" | "rtsp" | "rtmp" | "rtmpe" | "mms" | "f4m" | "ism" | "http_dash_segments" | "m3u8" | "m3u8_native";
    ...
    interface _BaseEntity {
        ...
        description: string;
        format: string;
        format_id: string; format_note: string;
        url: string;
        manifest_url?: string;
        app: string;
        play_path: string;
        ...
        fps: number; filesize: number; tbr: number; quality: number;
        duration?: number;
        start_time: number;
        ...
        requested_subtitles?: Record<string, {url: string, ext: string, data: string, _auto: boolean}>;
        formats?: Video[];
